...
//                	bar.setSelected(true);
                	...
                	if(title.equals("出库管理")){
                        ...
                        try{
                			...
                			JOptionPane.showMessageDialog(null, "请先初始化库存数据");


                	}else if(title.equals("入库管理")){
                		if(stock.StockExist()){
                		  try{
              		...
              		}else JOptionPane.showMessageDialog(null, "请先初始化库存数据");
          	
                	}else if(title.equals("库存盘点")){
                  		if(stock.StockExist()){
              		  try{
