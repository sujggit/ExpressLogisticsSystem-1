...
import ioputsl.IoputAudit;
import po.ReceiptsPO;
import receivesl.Deliver;
import sendsl.GsController;
...
public class AuditController implements AuditService {
	...
	private AuditInfo send, transport, deliver, finance,  gSend,
	ioputStock;
	...
	public AuditController() {
	    ...
	    gSend = new GsController(); 
	    ioputStock = new IoputAudit();
	}
...
//	
	...
	public ArrayList<IoputVO> getIoput() {
		// TODO Auto-generated method stub
		ioPut = (ArrayList<IoputVO>) ioputStock.getAuditInfo();
		return ioPut;
	}
