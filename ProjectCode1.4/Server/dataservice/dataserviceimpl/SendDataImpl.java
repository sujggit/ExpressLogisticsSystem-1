...
public class SendDataImpl extends UnicastRemoteObject implements SendDataService {
	...
	@Override
	public ArrayList<ReceiptsPO> findRAudit() throws RemoteException {
		// TODO Auto-generated method stub
		String sql = "select*from receiptspo where documentcondition='handing';";
		ReceiptsPO receiptsPO = null;
		ResultSet resultSet=null;
		ArrayList<ReceiptsPO> receipts = new ArrayList<ReceiptsPO>();
